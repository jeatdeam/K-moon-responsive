...
export const $header_template = document.querySelector('#header');
export const $footer_template = document.querySelector('#footer');


// const $header_add = $header_template.content.cloneNode(true);
// const $footer_add = $footer_template.content.cloneNode(true);
//
// document.querySelector('body').prepend($header_add);
// document.querySelector('body').appendChild($footer_add);
